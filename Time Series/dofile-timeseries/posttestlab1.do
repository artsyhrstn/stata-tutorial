...
desc
sum year usepop usgnp usunemp mincov
tsset year, yearly

/*
3. Buatl variabel logaritma dari variabel Rasio Pekerja di Amerika Serikat, GNP di  Amerika Serikat, pengangguran di Amerika Serikat, dan minimum coverage!(10%)  
*/
...
// Sesuai dengan tabel DW
// alpha: 0.05 
// k: 5 (total variabel, termasuk dependen)
// n: 38 (observasi)
// dl: 1.2042 
// du: 1.7916
// 4-dl: 2.7958
